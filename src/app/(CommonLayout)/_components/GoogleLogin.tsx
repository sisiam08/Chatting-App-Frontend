    ...
    <div className="min-h-screen flex flex-col justify-center items-center p-4 md:p-12 bg-[#07121f] text-white">
        ...
        <div className="w-full bg-[#0f172a] border border-white/10 rounded-3xl p-8 relative overflow-hidden shadow-[0_25px_80px_rgba(15,23,42,0.25)]">
          ...
          <div className="flex flex-col gap-6">
            <button
              ...
              className="w-full h-12 bg-[#111827] border border-white/10 hover:border-primary hover:bg-[#0f172a] hover:cursor-pointer transition duration-150 rounded-2xl flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed group"
              aria-label="Sign in with Google"
            >
              <GoogleIcon />
              <span className="text-sm font-medium text-white transition duration-150 group-hover:text-primary">
                Sign in with Google
              </span>
            </button>
      ...
      <footer className="fixed bottom-0 w-full p-4 md:p-12 flex justify-center md:justify-between items-center border-t border-white/10">
        ...
        <div className="flex gap-6">
          <Link
            href="/privacy"
            className="text-xs text-slate-400 hover:text-primary transition duration-150"
          >
            Privacy Policy
          </Link>
          <Link
